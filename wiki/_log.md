...
- 2026-06-20 — [Wiki schema](CLAUDE.md) — meta — Wiki structure scaffolded from `wiki-seed.md`.
- 2026-06-20 — [Architecture](architecture.md) — architecture — Real layout filled in: two-bucket repo (ai-seeds + code-quality-tools), bootstrap-loop diagram, no-build conventions.
